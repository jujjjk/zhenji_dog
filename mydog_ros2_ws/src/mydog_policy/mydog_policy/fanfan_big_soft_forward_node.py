...
# -*- coding: utf-8 -*-
"""
Big soft forward gait for Fanfan.

New node goal:
- Larger visible forward steps, but with soft timing and long support windows.
- Diagonal-sequence single-leg wave order: FL -> RR -> FR -> RL.
- Real hip joints can be locked to calibrated small in/out angles to reduce left-right sway.
- Lower-body posture: all calves are kept more bent so the trunk sits lower.
...
Install in setup.py, for example:
    'fanfan_big_soft_forward_node = mydog_policy.fanfan_big_soft_forward_node:main',
"""
...
class FanfanBigSoftForwardNode(Node):
    def __init__(self):
        super().__init__("fanfan_big_soft_forward_node")
        ...
        self.declare_parameter("step_hz", 0.48)
        ...
        self.declare_parameter("duty_factor", 0.86)
        self.declare_parameter("stride_length", 0.040)
        self.declare_parameter("swing_height", 0.070)
        self.declare_parameter("walk_direction", 1.0)
        self.declare_parameter("advance_start", 0.10)
        self.declare_parameter("advance_end", 0.90)
        self.declare_parameter("swing_lift_up_fraction", 0.24)
        self.declare_parameter("swing_lift_down_fraction", 0.30)
        self.declare_parameter("front_stride_gain", 0.96)
        ...
        self.declare_parameter("front_clearance_extra_m", 0.008)
        self.declare_parameter("rear_clearance_extra_m", 0.006)
        self.declare_parameter("front_thigh_delta_scale", 0.30)
        self.declare_parameter("rear_thigh_delta_scale", 0.15)
        self.declare_parameter("front_calf_lift_extra", 0.205)
        self.declare_parameter("rear_calf_lift_extra", 0.085)
        self.declare_parameter("front_swing_thigh_lift_bias", 0.022)
        self.declare_parameter("rear_swing_thigh_lift_bias", 0.007)
        self.declare_parameter("front_swing_forward_unfold", 0.008)
        ...
        self.declare_parameter("front_calf_min_rad", -1.34)
        ...
        self.declare_parameter("diag_support_preload_z_m", 0.008)
        self.declare_parameter("diag_support_calf_push_amp", 0.006)
        self.declare_parameter("diag_support_thigh_back_amp", 0.006)
        self.declare_parameter("other_support_preload_scale", 0.25)
        self.declare_parameter("support_stand_tall_m", -0.010)
        ...
        self.declare_parameter("front_stance_calf_bend_extra", 0.065)
        self.declare_parameter("rear_stance_calf_bend_extra", 0.085)
        # Optional small bend also during swing to keep the visual leg shape consistent.
        self.declare_parameter("front_swing_calf_bend_extra", 0.014)
        self.declare_parameter("rear_swing_calf_bend_extra", 0.012)
        ...
        self.declare_parameter("front_hip_kp", 42.0)
        ...
        self.declare_parameter("front_calf_kp", 50.0)
        self.declare_parameter("front_calf_kd", 4.4)
        self.declare_parameter("rear_hip_kp", 44.0)
        ...
        self.declare_parameter("front_swing_calf_kp", 58.0)
        ...
        self.declare_parameter("rear_swing_calf_kp", 42.0)
        ...
        # Safety / logging.
        self.declare_parameter("max_target_rate_rad_s", 1.50)
        ...
        self.pub_target = self.create_publisher(Float32MultiArray, "/mydog/fanfan_big_soft_forward_target_real", 10)
        self.pub_phase = self.create_publisher(Float32MultiArray, "/mydog/fanfan_big_soft_forward_phase", 10)
    ...
    def smooth_window(s: float, edge: float = 0.20) -> float:
        ...
        return FanfanBigSoftForwardNode.smootherstep(s / edge) * FanfanBigSoftForwardNode.smootherstep((1.0 - s) / edge)
