...
# -*- coding: utf-8 -*-
"""
Fanfan lateral side-step walk node.
...
Install as a ROS2 console script, for example in setup.py:
    'fanfan_side_step_walk_node = mydog_policy.fanfan_side_step_walk_node:main',
"""
...
class FanfanSideStepWalkNode(Node):
    def __init__(self):
        super().__init__("fanfan_side_step_walk_node")
        ...
        self.declare_parameter("duty_factor", 0.84)
        self.declare_parameter("lateral_hip_amp", 0.030)
        ...
        self.declare_parameter("front_lateral_gain", 0.92)
        self.declare_parameter("rear_lateral_gain", 0.84)
        self.declare_parameter("swing_height", 0.052)
        self.declare_parameter("front_swing_height_gain", 1.20)
        self.declare_parameter("rear_swing_height_gain", 1.00)
        self.declare_parameter("front_calf_lift_extra", 0.150)
        self.declare_parameter("rear_calf_lift_extra", 0.120)
        self.declare_parameter("front_thigh_lift_bias_amp", 0.018)
        self.declare_parameter("rear_thigh_lift_bias_amp", 0.014)
        ...
        self.declare_parameter("swing_lift_up_fraction", 0.14)
        self.declare_parameter("swing_lift_down_fraction", 0.18)
        self.declare_parameter("front_swing_clearance_extra_m", 0.006)
        self.declare_parameter("rear_swing_clearance_extra_m", 0.008)

        # Weight transfer / support shaping.
        self.declare_parameter("preload_fraction", 0.18)
        self.declare_parameter("support_preload_z_m", 0.006)
        self.declare_parameter("support_calf_push_amp", 0.014)
        self.declare_parameter("support_thigh_bias_amp", 0.006)
        self.declare_parameter("support_hip_brace_amp", 0.004)
        self.declare_parameter("same_side_support_scale", 0.35)
        self.declare_parameter("diagonal_support_bonus", 0.18)
        self.declare_parameter("support_stand_tall_m", 0.004)
        self.declare_parameter("landing_soften_fraction", 0.18)
        ...
        self.pub_target = self.create_publisher(Float32MultiArray, "/mydog/fanfan_side_step_target_real", 10)
        self.pub_phase = self.create_publisher(Float32MultiArray, "/mydog/fanfan_side_step_phase", 10)
    ...
    def smooth_window(s: float, edge: float = 0.18) -> float:
        ...
        return FanfanSideStepWalkNode.smootherstep(s / edge) * FanfanSideStepWalkNode.smootherstep((1.0 - s) / edge)
